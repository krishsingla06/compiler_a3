# Command-line argument test wrapper
.data
prog_name: .asciiz "test_comprehensive_cmdline"
arg_0: .asciiz "arg1"
arg_1: .asciiz "arg2"
arg_2: .asciiz "arg3"
...
main:
    ...
    # Push argv onto stack (parameter 2)
    addiu $sp, $sp, -8
    sw $a1, 4($sp)
    
    # Push argc onto stack (parameter 1)
    sw $a0, 0($sp)
...
# Functions from compiled program:
