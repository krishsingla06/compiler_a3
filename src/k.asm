    ...
    # ======================================
    # Added string literal: str_0 = ""Student 1 ID: %d\n""
    # Added string literal: str_1 = ""Student 2 ID: %d\n""
    # Added string literal: str_2 = ""Student 1's friend ID: %d\n""
...
.data
    # String Literals
str_0: .asciiz "Student 1 ID: %d\n"
str_2: .asciiz "Student 1's friend ID: %d\n"
str_1: .asciiz "Student 2 ID: %d\n"
...
I14:
    ...
    # DEBUG: format_param = '"Student 1 ID: %d\n"', first char = 34
