...
.globl main
    ...
    # TAC 0: 1: v_val_s1 = 100
I1:
    # --- Register Descriptor ---
    # --- End Register Descriptor ---
    # --- Storage Descriptor ---
    # --- End Storage Descriptor ---
    # Assignment: v_val_s1 = 100
    # DEBUG: v_val_s1 = constant 100 loaded in $t0 (dirty)
    li $t0, 100

    # End of block B1 - spilling all registers
    # DEBUG: Spilling 1 dirty registers
    # DEBUG: Spilled global/static v_val_s1 from $t0 to 0($gp)
...
I3:
    ...
    # --- End Storage Descriptor ---
    # #t1 = &v_val_s1
    # DEBUG: #t1 = address of global/static v_val_s1 at $gp
    # DEBUG: #t1 (pointer) in $t0 (dirty)
    move $t0, $gp

    # TAC 3: 4: v_p_modify_s2 = #t1
I4:
    # --- Register Descriptor ---
    # $t0: [#t1] (dirty)
    # --- End Register Descriptor ---
    ...
    # v_val_s1: [memory:0($gp)]
    # --- End Storage Descriptor ---
    # Assignment: v_p_modify_s2 = #t1
    # DEBUG: #t1 already in $t0
    # DEBUG: v_p_modify_s2 now also in $t0 (dirty)
    # DEBUG: Saved v_p_modify_s2 to memory at -8($fp)
    sw $t0, -8($fp)

    # TAC 4: 5: #t2 = v_p_modify_s2
I5:
    # --- Register Descriptor ---
    # $t0: [#t1, v_p_modify_s2] (dirty)
    # --- End Register Descriptor ---
    # --- Storage Descriptor ---
    # #t1: [$t0]
    # v_p_modify_s2: [$t0, memory:-8($fp)]
    # v_val_s1: [memory:0($gp)]
    # --- End Storage Descriptor ---
    # Assignment: #t2 = v_p_modify_s2
    # DEBUG: v_p_modify_s2 already in $t0
...
I6:
    ...
    # DEBUG: Invalidating cached value of v_p_modify_s2 in $t0
    li $t1, 200
    sw $t1, 0($t0)

    # TAC 6: 7: end function modify
I7:
    # --- Register Descriptor ---
    # $t0: [#t1, #t2] (dirty)
    # $t1: [<CONST_5_200>]
    ...
    # #t2: [$t0, memory:-12($fp)]
    # <CONST_5_200>: [$t1]
    # v_p_modify_s2: [memory:-8($fp)]
    # v_val_s1: [memory:0($gp)]
    # --- End Storage Descriptor ---
    # === Function Epilogue for modify ===
    move $sp, $fp
