...
.globl main
    ...
    # Instr i5 Next-Use:
    #   store_through_pointer -> N/A
    # Instr i4 Next-Use:
    #   #t2 -> N/A
    # Instr i3 Next-Use:
    #   #t2 -> N/A
    #   v_p_store_through_pointer_s2 -> N/A
    # Instr i2 Next-Use:
    #   #t1 -> N/A
    #   v_p_store_through_pointer_s2 -> N/A
    # Instr i1 Next-Use:
    ...
    # TAC 0: 1: function begin : store_through_pointer
I1:
    # --- Register Descriptor ---
...
store_through_pointer:
    # Function: store_through_pointer
    # === Function Prologue for store_through_pointer ===
    # Frame size: 60 bytes
    addiu $sp, $sp, -60
...
I2:
    ...
    # --- End Storage Descriptor ---
    # #t1 = &v_global_val_s1
    # DEBUG: #t1 = address of global/static v_global_val_s1 at $gp
    # DEBUG: #t1 (pointer) in $t0 (dirty)
    move $t0, $gp

    # TAC 2: 3: v_p_store_through_pointer_s2 = #t1
I3:
    # --- Register Descriptor ---
    # $t0: [#t1] (dirty)
    # --- End Register Descriptor ---
    ...
    # #t1: [$t0]
    # --- End Storage Descriptor ---
    # Assignment: v_p_store_through_pointer_s2 = #t1
    # DEBUG: #t1 already in $t0
    # DEBUG: v_p_store_through_pointer_s2 now also in $t0 (dirty)
    # DEBUG: Saved v_p_store_through_pointer_s2 to memory at -8($fp)
    sw $t0, -8($fp)

    # TAC 3: 4: #t2 = v_p_store_through_pointer_s2
I4:
    # --- Register Descriptor ---
    # $t0: [#t1, v_p_store_through_pointer_s2] (dirty)
    # --- End Register Descriptor ---
    # --- Storage Descriptor ---
    # #t1: [$t0]
    # v_p_store_through_pointer_s2: [$t0, memory:-8($fp)]
    # --- End Storage Descriptor ---
    # Assignment: #t2 = v_p_store_through_pointer_s2
    # DEBUG: v_p_store_through_pointer_s2 already in $t0
...
I5:
    # --- Register Descriptor ---
    # $t0: [#t1, #t2, v_p_store_through_pointer_s2] (dirty)
    # --- End Register Descriptor ---
    # --- Storage Descriptor ---
    # #t1: [$t0]
    # #t2: [$t0, memory:-12($fp)]
    ...
    # DEBUG: Loaded constant 100 into $t1
    # DEBUG: Integer value 100 in $t1
    # DEBUG: Stored integer 100 through pointer #t2
    # DEBUG: Invalidating all cached values due to pointer store
    # DEBUG: Invalidating cached value of v_p_store_through_pointer_s2 in $t0
    li $t1, 100
    sw $t1, 0($t0)

    # TAC 5: 6: end function store_through_pointer
I6:
    # --- Register Descriptor ---
    # $t0: [#t1, #t2] (dirty)
    # $t1: [<CONST_4_100>]
    ...
    # #t2: [$t0, memory:-12($fp)]
    # <CONST_4_100>: [$t1]
    # v_p_store_through_pointer_s2: [memory:-8($fp)]
    # --- End Storage Descriptor ---
    # === Function Epilogue for store_through_pointer ===
    move $sp, $fp
    ...
    # Return to caller
    # === End of Epilogue ===
    # End of function: store_through_pointer
...
I8:
    ...
    # TAC 8: 9: #t3 = call store_through_pointer, 0
I9:
    # --- Register Descriptor ---
    ...
    # v_p_store_through_pointer_s2: [memory:-8($fp)]
    # --- End Storage Descriptor ---
    # Call store_through_pointer with 0 arguments
    # === Caller-Save: Spill ALL registers before call ===
    # === End Caller-Save ===
    # DEBUG: Called store_through_pointer
